The [gateway_template.js](https://github.com/di-unipi-socc/bonsaifog/blob/master/gateway_module/gateway_template.js) file contains the primer code to run on the instructor's and students' laptop. 
